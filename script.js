document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            "Download your preferred client": "Download your preferred client",
            "Extract the ZIP file to a folder": "Extract the ZIP file to a folder",
            "Run the installer executable": "Run the installer executable",
            "Follow the setup wizard instructions": "Follow the setup wizard instructions",
            "Launch Minecraft and enjoy!": "Launch Minecraft and enjoy!",
            "For support or questions, join our": "For support or questions, join our",
            "High-performance Minecraft client for advanced users.": "High-performance Minecraft client for advanced users.",
            "Feature-rich Minecraft client with advanced capabilities.": "Feature-rich Minecraft client with advanced capabilities.",
            "Innovative Minecraft client with unique features.": "Innovative Minecraft client with unique features.",
            "Version:": "Version:",
            "Size:": "Size:",
            "Download": "Download"
        },
        vi: {
            ...
            "English": "Tiếng Anh",
            "Downloads": "Tải xuống",
            "Available Downloads": "Các mục có thể tải xuống",
            "Installation Instructions": "Hướng dẫn cài đặt",
            "Download your preferred client": "Tải xuống client bạn muốn",
            "Extract the ZIP file to a folder": "Giải nén file ZIP vào một thư mục",
            "Run the installer executable": "Chạy file cài đặt",
            "Follow the setup wizard instructions": "Làm theo hướng dẫn cài đặt",
            "Launch Minecraft and enjoy!": "Khởi động Minecraft và tận hưởng!",
            "For support or questions, join our": "Để được hỗ trợ hoặc có thắc mắc, hãy tham gia",
            "High-performance Minecraft client for advanced users.": "Client Minecraft hiệu suất cao cho người dùng nâng cao.",
            "Feature-rich Minecraft client with advanced capabilities.": "Client Minecraft đa tính năng với khả năng nâng cao.",
